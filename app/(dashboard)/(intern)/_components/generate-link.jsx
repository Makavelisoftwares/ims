...
export const GenereateInternLink = () => {
  ...
  const handleGenerate = () => {
    setnewOrganizationId(`${origin}/share/intern/${orgnizationId}/${userId}`);
    setsetShow(true);
  };
  ...
  return (
    <AlertDialog open={isOpen} onOpenChange={setisOpen}>
      <AlertDialogTrigger>
        ...
        >
          <Link />
          <span>Copy and Share Intern Link</span>
        </Button>
      </AlertDialogTrigger>
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>Share intern links.</AlertDialogTitle>
          <AlertDialogDescription>
            Visit your organisation page . Copy and paste any of your organization's id
            on the field below.Copy and share the generated link to your prefered intern.
          </AlertDialogDescription>
        </AlertDialogHeader>
